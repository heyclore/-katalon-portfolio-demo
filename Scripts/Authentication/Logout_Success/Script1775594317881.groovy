...
WebUI.verifyElementPresent(homePage.appointmentButton, 0)

WebUI.click(homePage.dropdownMenu.dropdown_toggle_button)

WebUI.click(homePage.dropdownMenu.logoutButton)

WebUI.verifyElementVisible(homePage.homepageTitle, FailureHandling.STOP_ON_FAILURE)
